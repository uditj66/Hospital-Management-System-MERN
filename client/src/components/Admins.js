...
export default function AdminDashboard() {
  ...
  const fetchTotalDoctors = async () => {
    try {
      ...
      const response = await fetch(`${apiURL}/api/admin/total-doctors`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchTotalPatients = async () => {
    try {
      ...
      const response = await fetch(`${apiURL}/api/admin/total-patients`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchDoctorOverview = async () => {
    try {
      ...
      const response = await fetch(`${apiURL}/api/admin/doctor-overview`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const fetchPatientOverview = async () => {
    try {
      ...
      const response = await fetch(`${apiURL}/api/admin/patient-overview`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
